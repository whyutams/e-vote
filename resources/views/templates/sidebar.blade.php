   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            ...
            class="flex items-center p-2 rounded-lg group hover-scale
            {{ Request::is('dashboard/settings') ? 'bg-gray-900 text-gray-100 dark:bg-gray-700 dark:text-white' : 'text-gray-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
