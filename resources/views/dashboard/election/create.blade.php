...
<div class="mt-6 ms-1 me-1 max-w-5xl mx-auto mb-5">
    <div class="flex flex-col md:flex-row">
        ...
        <!-- Kolom Form -->
        <div class="flex-1 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 p-6">
                ...
                <form>
                    ...
                    <div class="mt-5 sm:mt-8">
                        ...
                        <div id="kandidat-container" class="space-y-6">
                            <!-- Kandidat Template -->
                            <div class="kandidat-item bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-lg p-6">
                                <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Data Kandidat</h3>
                                <div class="flex flex-col md:flex-row gap-6">
                                    <div class="flex-1">
                                        ...
                                        <div class="mb-5">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Wakil</label>
                                            <input type="text" name="kandidat[0][wakil]" 
                                        ...
                                        <div class="mb-5">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Visi</label>
                                            <textarea name="kandidat[0][visi]" rows="2" 
                                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg 
                                                    border border-gray-300 focus:ring-blue-500 focus:border-blue-500 
                                                    dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                                        </div>
                                    ...
                                    <div class=" flex-1">
                                        <!-- Kolom Upload Gambar -->
                                        <div class="w-full self-start bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 p-6 flex flex-col items-center justify-center">
                                            <!-- Preview -->
                                            <div class="w-full h-full flex items-center justify-center bg-gray-100 rounded-lg mb-4">
                                            ...
                                            <input type="file" name="kandidat[0][photo]" id="upload" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mt-5 flex justify-between items-center gap-x-2">
                            ...
                            <button type="submit" class="py-2 px-3 inline-flex items-center gap-x-1 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-stepper-finish-btn="" style="display: none;">
                                Selesai
                            </button>
