        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 ">
            ...
            <tbody>
                <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
                    <td class="w-4 p-4">
                        <div class="flex items-center">
                            <input id="checkbox-table-search-1" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500"zzzz>
                    ...
                    <td class="px-6 py-4">
                        <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm">Draft</span>
                    </td>
                    <td class="px-6 py-4">
                        2025-05-12 08:00:00
                    </td>
