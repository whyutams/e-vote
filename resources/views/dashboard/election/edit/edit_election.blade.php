...
@section('content')
    ...
    <div class="mt-6 ms-1 me-1 max-w-5xl mx-auto mb-5">
        <form action="{{ route('dashboard.elections.update', $election->id) }}" method="POST">
            @csrf
            <div class="bg-gray-50 dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-lg p-6">
                ...
                <div class="mb-5">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Judul
                        Pemilihan</label>
                    <input type="text" id="title" name="title" value="{{ old('title', $election->title) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                ...
                <div class="mb-5">
                    ...
                    <textarea id="description" rows="4" name="description"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $election->description) }}</textarea>
                </div>
