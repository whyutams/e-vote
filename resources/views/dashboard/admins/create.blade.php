...
@section('content')
    ...
    <div class="mt-6 ms-1 me-1 max-w-5xl mx-auto mb-5">
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <!-- Kolom Form -->
            <div
                class="flex-1 bg-white border border-gray-200 rounded-lg shadow-sm p-6 md:p-8">
                @if ($errors->any())
                ...
                <form action="{{ route('dashboard.admins.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        <label for="callname" class="block mb-2 text-sm font-medium text-gray-900 ">Nama
                            Panggilan <span class="me-2 text-red-600">*</span></label>
                        <input value="{{ old('callname') }}" type="text" id="callname" name="callname"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                                                       focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="{{ old('email') }}" type="text" id="email" name="email" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg 
                    ...
                    <div class="mb-5">
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 ">No.
                            HP</label>
                        <input value="{{ old('phone') }}" type="text" id="phone" name="phone" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg 
                                                       bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input value="{{ old('username') }}" type="text" id="username" name="username" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg 
                                                       bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 ">Password
                            <span class="me-2 text-red-600">*</span></label>
                        <input value="{{ old('password') }}" type="password" id="password" name="password" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg 
                                                       bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" required>
                    </div>

                    <div class="mb-5">
                        <label for="password_confirmation"
                            class="block mb-2 text-sm font-medium text-gray-900 ">Konfirmasi Password <span
                                class="me-2 text-red-600">*</span></label>
                        <input value="{{ old('password_confirmation') }}" type="password" name="password_confirmation"
                            id="password_confirmation" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg 
                                                       bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
